...
stat_ids = ['cmp-a001-01-000000005163447','cmp-a001-01-000000005467913','cmp-a001-01-000000005813840','cmp-a001-01-000000005813843','cmp-a001-01-000000005851689']
r = requests.get(BASE_URL + uri, params={'ids': stat_ids, 'fields': '["clkCnt","impCnt","salesAmt", "ctr", "cpc", "avgRnk", "ccnt"]', 'timeRange': '{"since":"2022-11-01","until":"2022-11-30"}'}, headers=get_header(method, uri, API_KEY, SECRET_KEY, CUSTOMER_ID))
